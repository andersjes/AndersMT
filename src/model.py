...
import src.VisionFM.models as vision_fm
#from torchvision.models import resnet18, resnet34, resnet50, resnet101, resnet152
from torchvision import models
import torch.nn as nn
from timm.models.resnet import resnet50,resnet200d
...
class FoundationalCVModel(torch.nn.Module):
    ...
    def __init__(self, backbone, mode='eval', weights=None):
        ...
        # https://pytorch.org/vision/main/models/generated/torchvision.models.swin_t.html#torchvision.models.swin_t
        ...
        elif backbone in ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152', 'resnet200d']:
            ...
            raise ValueError(f"Unsupported backbone model: {backbone} \n Supported models: 'dinov2_small', 'dinov2_base', 'dinov2_large', 'dinov2_giant', 'convnextv2_tiny', 'convnextv2_base', 'convnextv2_large', 'convnext_tiny', 'convnext_small', 'convnext_base', 'convnext_large', 'swin_tiny', 'swin_small', 'swin_base', 'vit_base', 'vit_large', 'clip_base', 'clip_large', 'retfound', 'visionfm'")
